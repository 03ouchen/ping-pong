...
wind.title("Ping Pong by Ouchen")  # set the title of the window 
wind.bgcolor("black") # set the color of the window 
wind.setup(width=800, height=600) # set the height and width of the window 
...
madrab1.shapesize(stretch_wid=5, stretch_len=1) # stretshes the shape to meet the size 
madrab1.penup() #stopes the object from drawing lines  
...
wind.onkeypress(madrab1_up, "u") #when pressing u the function madrab1_up is invoked  
wind.onkeypress(madrab1_down, "d")
